...
public final class GastroSphereConstants {
    ...
    public static final String MENU_NÃO_ENCONTRADO_ID = "Menu não encontrado para o ID: ";
	public static final String MENU_ITEM_NÃO_ENCONTRADO = "Menu Item não encontrado para o ID: ";
}
