...
import static br.com.fiap.gastrosphere.core.application.utils.GastroSphereUtils.convertToUser;
...
public class UserController {
    ...
    public ResponseEntity<List<UserBodyResponse>> findAllUsers(
        ...
        Page<UserModel> users = this.userService.findAllUsers(page, size);
    ...
    public ResponseEntity<UUID> createUser(@Valid @RequestBody UserBodyRequest userRequestBody) {
        ...
        UserModel user = userService.createUser(convertToUser(userRequestBody));
